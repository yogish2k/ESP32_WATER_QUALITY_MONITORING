...
uint8_t alternateAddress[] = {0xEC, 0x94, 0xCB, 0x6F, 0x74, 0x6C}; 

uint8_t i=1; //used as packet number when sent to NODE 6
uint8_t j=1; //used as packet number when sent to NODE 7
const int oneWireBus = 0;
esp_now_peer_info_t peerInfo;
// Structure example to send data
// Must match the receiver structure
typedef struct struct_message {
  int id;          //Unique ID i.e 10
  int num;         //packet number
  int sensorinfo;  //sensor data +100 constant
} struct_message;
