...
struct_message boardsStruct[3] = {board5,board10,board12};
...
void OnDataRecv(const uint8_t * mac_addr, const uint8_t *incomingData, int len) {
  ...
  switch(myData2.id){
    ...
    break;
      ...
      esp_err_t result2 = esp_now_send(broadcastAddress, (uint8_t *) &boardsStruct[k], sizeof(boardsStruct[k]));
