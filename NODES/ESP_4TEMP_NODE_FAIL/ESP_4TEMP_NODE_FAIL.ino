...
uint8_t broadcastAddress[] = {0x08, 0x3A, 0xF2, 0xA9, 0x73, 0xB8};
uint8_t alternateAddress[] = {0x08, 0x3A, 0xF2, 0x51, 0x00, 0x00}; 
uint8_t i=1; //used as packet number when sent to NODE 2
uint8_t j=1; //used as packet number when sent to NODE 9
...
typedef struct struct_message {
  int id;          //Unique ID i.e 4
  int num;         //packet number
  int sensorinfo;  //sensor data +40 constant
} struct_message;
